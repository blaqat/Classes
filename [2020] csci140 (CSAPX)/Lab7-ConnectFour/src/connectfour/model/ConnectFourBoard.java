...
public class ConnectFourBoard {
    ...
    /**
     * Returns the next row that a disk will be placed on in a column or -1 if no places left
     * @param col the column the player will be placing their piece into
     * @return int
     */
    public int getPlacementRow(int col){
