...
char *col_str(char *color, char *message, ...) {
  ...
  char *f = format("\x1B[%dm%s\x1B[0m", get_color(color), buffer);
  return f;
}
 ...
 * @param message
 */
void sym(char *message) { input(col_str("magenta", message)); }
 ...
 * @param message
 */
void info(char *message) { println(col_str("green", message)); }
 ...
 * @param message
 */
void warn(char *message) { println(col_str("yellow", message)); }
/**
 * @brief Print a message to the console in red
 *
 * @param message
 */
void error(char *message) { println(col_str("red", message)); }
...
/**
 * @brief Captures 1 line of text from console. Returns nul terminated string
 * when \n is entered
 *
 * @param buffer
 * @param max_length
...
/**
 * @brief Prompts user for an input with a formatted message, then captures 1
...
/**
 * @brief Prompts user for an input, then captures 1 line of text from console
 *
 * @param message
 * @return char*
 */
...
int parse_int(char *string) {
  char fchar;
  int num;
  return sscanf(string, "%d%c", &num, &fchar) == 1 ? num : -1;
};
