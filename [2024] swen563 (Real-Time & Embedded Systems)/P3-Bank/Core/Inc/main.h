...
#define Teller1_Pin SHLD_A1_Pin
#define Teller2_Pin SHLD_A2_Pin
#define Teller3_Pin SHLD_A3_Pin

// Loop function based on rust's loop for infinite loops
#define loop while (1)

#define TRUE 1
#define FALSE 0

// Initialize a struct to the heap
