...
public final class Application {
  ...
  public static void main(String[] args) {
    ...
    final TournamentCenter tournamentCenter = new TournamentCenter(gameCenter);
    final WebServer webServer = new WebServer(gameCenter, playerLobby, tournamentCenter, templateEngine, gson);
